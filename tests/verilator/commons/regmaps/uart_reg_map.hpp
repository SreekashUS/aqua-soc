...
#define UART_REG_STATUS		 	UART_REG_BASE+0x10
#define UART_REG_INT_STATUS		UART_REG_BASE+0x14
#define UART_REG_INT_MASK  		UART_REG_BASE+0x18
#define UART_REG_INT_PEND 		UART_REG_BASE+0x1C
#define UART_REG_INT_CLR 		UART_REG_BASE+0x20
#define UART_REG_END 			UART_REG_BASE+0x24
